...
import { listDefaultWorkspaceDirectories } from "./default-workspace";
...
export async function getAllowedFileRoots(): Promise<Set<string>> {
  ...
  // Also allow ~/.pi/default-workspace/<YYYYMMDD> directories created by the
  // default-cwd endpoint, including after a server restart.
  for (const dir of listDefaultWorkspaceDirectories(homedir())) {
    roots.add(normalizeSlashes(dir));
  }
